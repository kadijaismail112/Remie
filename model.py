...
prompt = """You are a chatbot assistant that helps people with their daily tasks. I want for you to classify questions given what you think they are.
...
If you think the question is a general question, then give me a 1. 
...
classifier = [{"role": "system", "content": prompt}]
chat_log = []
